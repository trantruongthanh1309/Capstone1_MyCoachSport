    ...
    <>
      <header className="navbar">
        <div className="navbar-container">
          <div className="logo">
            <Link to="/" className="logo-text">MySportCoachAI</Link>
          </div>

          <nav className="navbar-links">
            <Link to="/home" className="navbar-link">Trang chủ</Link>
            <Link to="/planner" className="navbar-link">Planner</Link>
            <Link to="/logs" className="navbar-link">Nhật ký</Link>
            <Link to="/leaderboard" className="navbar-link">BXH</Link>
            <Link to="/social" className="navbar-link">Bảng tin</Link>
            <Link to="/videos" className="navbar-link">Video</Link>
          </nav>
